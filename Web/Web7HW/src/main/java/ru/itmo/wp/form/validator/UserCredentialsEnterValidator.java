...
public class UserCredentialsEnterValidator implements Validator {
    ...
    public void validate(Object target, Errors errors) {
        if (!errors.hasErrors()) {
            ...
            } else if (userService.findByLoginAndPassword(enterForm.getLogin(), enterForm.getPassword()).getDisabled().equals("true")) {
                errors.rejectValue("password","invalid.login.or.password", "User is disabled");
            }
