...
public class HttpServer {
    ...
    private void process(Request request, Response response) throws IOException {
        ...
        if (file.isFile()) {
            ...
            String digest = Long.toString(file.length() + file.lastModified());
            if (request.getHeader("If-None-Match") != null && request.getHeader("If-None-Match").equals(digest)) {
    ...
    private static final class Request {
        ...
        private Request(String request) {
            ...
            firstLineTokens[1] = java.net.URLDecoder.decode(firstLineTokens[1], StandardCharsets.UTF_8);
            if (!(firstLineTokens[1].endsWith("html") || firstLineTokens[1].endsWith("htm") || firstLineTokens[1].endsWith("png"))) {
                uri = firstLineTokens[1] + "/index.html";
            } else {
