...
public class UserService {
    ...
    public void validateRegistration(User user, String password, String passwordConfirmation) throws ValidationException, SQLException {
        ...
        if (user.getEmail().length() > 20) {
            throw new ValidationException("Email can't be longer than 20 letters");
        }
    ...
    public User find(long id) throws SQLException {return userRepository.find(id);}

    public int findCount(){
        return userRepository.findCount();
    }

    public User validateAndFindByLoginOrEmailAndPassword(String loginOrEmail, String password) throws ValidationException, SQLException {
