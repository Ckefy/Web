export default {
    ...
    comments: {
        1: {id: 1, user_id: 1, postId: 4, text: "Thanks, tourist"},
        2: {id: 2, user_id: 5, postId: 4, text: "You can read more on Wikipedia"},
        3: {id: 3, user_id: 1, postId: 4, text: "Great!"},
        4: {id: 4, user_id: 1, postId: 5, text: "Welcome to the round."},
        5: {id: 5, user_id: 7, postId: 5, text: "Can Div.1 take part unofficially?"},
        6: {id: 6, user_id: 5, postId: 5, text: "I hope"},
        8: {id: 8, user_id: 11, postId: 8, text: "Please, write about TopCoder SRM 737"},
        9: {id: 9, user_id: 7, postId: 8, text: "I'll do"}
    }
}
